...
email = MIMEMultipart()
# 设置发件人、收件人和主题
email['From'] = 'wy201904091002@qq.com'
email['To'] = 'wy201904091002@qq.com'
...
# 通过用户名和授权码进行登录
smtp_obj.login('wy201904091002@qq.com', 'rkrorewnmftmdfgb')
# 发送邮件（发件人、收件人、邮件内容（字符串））
smtp_obj.sendmail(
    'wy201904091002@qq.com',
    ['wy201904091002@qq.com', '1250407177@qq.com'],
    email.as_string()
)